...
CREATE TABLE `shipment` (
  ...
  `ExpectShipmentTime` datetime DEFAULT NULL,
  `ExpectArriveTime` datetime DEFAULT NULL,
  `RealShipmentTime` datetime DEFAULT NULL,
  `RealArriveTime` datetime DEFAULT NULL,
  `EventID` int DEFAULT NULL,
  PRIMARY KEY (`ShipmentID`),
  KEY `idx_shipment_eventid` (`EventID`),
  KEY `idx_shipment_realarrivetime` (`RealArriveTime`),
  CONSTRAINT `shipment_ibfk_1` FOREIGN KEY (`EventID`) REFERENCES `event` (`EventID`)
